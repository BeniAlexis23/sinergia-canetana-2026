    ...
    <div>
      ...
      <section className="hero-scene text-white">
        <div className="section-shell grid min-h-[calc(100vh-72px)] items-center gap-10 py-14 lg:grid-cols-[1.04fr_0.96fr]">
          <div>
            <p className="mb-5 inline-flex rounded bg-secondary px-4 py-2 text-sm font-black uppercase tracking-wide text-ink">Elecciones universitarias 2026</p>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-white/86">
              Sinergia Canetana es una campana universitaria de centro estudiantil: dialogante, transparente y enfocada en desarrollar el talento de cada estudiante.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <a href="#participa" className="inline-flex items-center gap-2 rounded bg-secondary px-5 py-3 font-black text-ink">
                Participa con nosotros
                <ArrowRight size={18} />
              </a>
              <a href="#objetivos" className="inline-flex rounded border border-white/35 px-5 py-3 font-bold text-white">Ver objetivos</a>
            </div>
          </div>

          <div className="rounded-lg border border-white/18 bg-white p-6 text-ink shadow-soft">
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-3">
              <div className="rounded bg-violetSoft p-4">
      ...
      <section id="participa" className="scroll-mt-24 bg-secondary py-10 text-ink">
        <div className="section-shell flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <a href="#noticias" className="inline-flex items-center gap-2 rounded bg-ink px-5 py-3 font-black text-white">
            Ver comunicados
            <ArrowRight size={18} />
          </a>
        </div>
      ...
      <section id="objetivos" className="scroll-mt-24 bg-violetSoft py-20">
      ...
      <footer className="bg-primary py-8 text-white">
        <div className="section-shell flex flex-col gap-3 text-sm text-white/78 md:flex-row md:items-center md:justify-between">
          <p>Sinergia Canetana. Movimiento universitario local.</p>
